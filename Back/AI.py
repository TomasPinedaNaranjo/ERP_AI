...
- Tener presente que hay una o más tablas en la base de datos.
...
def generate_user_answer(user_input, query_result):
    ...
    ### Tarea:
    - Analiza el resultado de la consulta SQL.
    - Genera una respuesta clara y concisa basada en el resultado.
    - Si el resultado involucra múltiples tablas, explica la relación entre los datos.
    """
